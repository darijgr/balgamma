% The version to be submitted to the journal.
...
%TCIDATA{LastRevised=Monday, November 10, 2025 18:47:56}
...
{}
\theoremstyle{plainsl}
\ihead{An equality for balanced digraphs, version submit-1}
\ohead{page \thepage}
\cfoot{}
\begin{document}
