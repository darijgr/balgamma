...
%TCIDATA{LastRevised=Sunday, July 13, 2025 19:55:42}
...
our proof of Lemma \ref{lem.realignment-acyc} \textbf{(b)}.
\end{proof}
...
\begin{statement}
\textit{Claim 3:} We have $\Psi_{P^{\prime},Q^{\prime}}\circ\Phi
_{P,Q}=\operatorname*{id}$.
\end{statement}

\begin{statement}
\textit{Claim 4:} We have $\Phi_{P,Q}\circ\Psi_{P^{\prime},Q^{\prime}%
}=\operatorname*{id}$.
\end{statement}
